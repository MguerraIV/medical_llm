...
- Exemplo:
  ```
  Input: Given the following symptoms, provide the most likely diagnosis, description, and risk factors. Symptoms: anxiety and nervousness, breathing fast, chest tightness.
